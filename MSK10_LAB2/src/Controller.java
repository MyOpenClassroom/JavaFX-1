...
public class Controller {
    ...
    @FXML
    private Label theFirstErrorTwo;
    ...
    public void buttonStartAction() {
        ...
        try {
            ...
            theFirstErrorOne.setText("МОЖНО ВВОДИТЬ");
            theFirstErrorTwo.setText("ТОЛЬКО ЧИСЛА!");
