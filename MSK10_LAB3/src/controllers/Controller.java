...
public class Controller extends Main {
    ...
    @FXML
    private Label theSecondExceptionLabel;
    @FXML
    private Label theFirstArithmeticExceptionLabel;
    @FXML
    private Label theSecondArithmeticExceptionLabel;
    @FXML
    ...
    public void buttonStartAction () {
        ...
        theSecondExceptionLabel.setTextFill(Color.web("#000000"));

        theFirstArithmeticExceptionLabel.setTextFill(Color.web("#000000"));
        theSecondArithmeticExceptionLabel.setTextFill(Color.web("#000000"));
        ...
        try {
            ...
            theSecondArithmeticExceptionLabel.setTextFill(Color.web("#FF0000"));
            ...
            theSecondExceptionLabel.setTextFill(Color.web("#FF0000"));
        }
    ...
    public void addRandomNums () {
        ...
        for (int i = 0; i < COUNT_ROW; i++) {
            ...
            String formattedDouble = String.format("%.5f", randomNum);
            //randomNum = Double.parseDouble(formattedDouble);

            // Заполняем данные и ответ вычисления в таблицу
            items.add(new NumericGenerator(formattedDouble, solveTheTaskRandom(randomNum,sum, a, b)));
        }
    ...
    public String solveTheTaskRandom (double num, double sum, int a, int b) {
        ...
        double aNum = a;
        double bNum = b;
        result = String.format("%.5f", Math.sqrt(Math.pow(Math.cos(num), 2)/((Math.pow(aNum, 2) + Math.pow(bNum, 2)) - Math.sin(num)))*(sum-num));
        return result;
    }
